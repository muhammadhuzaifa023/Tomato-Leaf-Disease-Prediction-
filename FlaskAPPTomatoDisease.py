# -*- coding: utf-8 -*-
"""
Created on Sun Aug 21 18:19:40 2022
...
filepath = 'D:/DataScience/Deep Learning/Create the CNN/Tomoato Disease Prediction/Plant-Leaf-Disease-Prediction-main/Plant-Leaf-Disease-Prediction-main/model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('D:/DataScience/Deep Learning/Create the CNN/Tomoato Disease Prediction/Plant-Leaf-Disease-Prediction-main/Plant-Leaf-Disease-Prediction-main/static/upload/', filename)
        file.save(file_path)
